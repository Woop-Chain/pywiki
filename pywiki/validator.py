"""
Load validator information from Woop blockchain
...
class Validator:  # pylint: disable=too-many-instance-attributes, too-many-public-methods
    ...
    def sign_create_validator_transaction( # pylint: disable=too-many-arguments
        ...
        API Reference
        -------------
        https://github.com/woop-chain/sdk/blob/99a827782fabcd5f91f025af0d8de228956d42b4/packages/woop-staking/src/stakingTransaction.ts#L413
        """
    ...
    def sign_edit_validator_transaction( # pylint: disable=too-many-arguments
        ...
        API Reference
        -------------
        https://github.com/woop-chain/sdk/blob/99a827782fabcd5f91f025af0d8de228956d42b4/packages/woop-staking/src/stakingTransaction.ts#L460
        """
        self.set_rate( rate )
