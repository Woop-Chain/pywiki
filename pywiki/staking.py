...
def get_all_validator_addresses(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#69b93657-8d3c-4d20-9c9f-e51f08c9b3f5
    """
    method = "wikiv2_getAllValidatorAddresses"
    try:
...
def get_validator_information(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#659ad999-14ca-4498-8f74-08ed347cab49
    """
    method = "wikiv2_getValidatorInformation"
...
def get_elected_validator_addresses(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#e90a6131-d67c-4110-96ef-b283d452632d
    """
    method = "wikiv2_getElectedValidatorAddresses"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_validators(
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/staking.go#L152
    """
...
def get_validator_information_by_block_number(
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/staking.go#L319
    """
    method = "wikiv2_getValidatorInformationByBlockNumber"
...
def get_all_validator_information(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#df5f1631-7397-48e8-87b4-8dd873235b9c
    """
    method = "wikiv2_getAllValidatorInformation"
    params = [ page ]
    try:
        return rpc_request(
            method,
...
def get_validator_self_delegation(
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/staking.go#L352
    """
    method = "wikiv2_getValidatorSelfDelegation"
    params = [ address ]
    try:
        return int(
            rpc_request(
...
def get_validator_total_delegation(
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/staking.go#L379
    """
    method = "wikiv2_getValidatorTotalDelegation"
    params = [ address ]
    try:
        return int(
            rpc_request(
...
def get_all_validator_information_by_block_number(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#a229253f-ca76-4b9d-88f5-9fd96e40d583
    """
    method = "wikiv2_getAllValidatorInformationByBlockNumber"
...
def get_all_delegation_information(
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/staking.go#L413
    """
    method = "wikiv2_getAllDelegationInformation"
    params = [ page, ]
    try:
        return rpc_request(
            method,
...
def get_delegations_by_delegator(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#454b032c-6072-4ecb-bf24-38b3d6d2af69
    """
    method = "wikiv2_getDelegationsByDelegator"
...
def get_delegations_by_delegator_by_block_number(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#8ce13bda-e768-47b9-9dbe-193aba410b0a
    """
    method = "wikiv2_getDelegationsByDelegatorByBlockNumber"
...
def get_delegation_by_delegator_and_validator(
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/staking.go#L605
    """
    method = "wikiv2_getDelegationByDelegatorAndValidator"
...
def get_available_redelegation_balance(
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/staking.go#L653
    """
    method = "wikiv2_getAvailableRedelegationBalance"
    params = [ delegator_addr ]
    try:
        return int(
            rpc_request(
...
def get_delegations_by_validator(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#2e02d8db-8fec-41d9-a672-2c9862f63f39
    """
    method = "wikiv2_getDelegationsByValidator"
    params = [ validator_addr ]
    try:
        return rpc_request(
            method,
...
def get_current_utility_metrics(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#78dd2d94-9ff1-4e0c-bbac-b4eec1cdf10b
    """
    method = "wikiv2_getCurrentUtilityMetrics"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_staking_network_info(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#4a10fce0-2aa4-4583-bdcb-81ee0800993b
    """
    method = "wikiv2_getStakingNetworkInfo"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_super_committees(
        ...
        quorum-deciders: :obj:`dict` dictionary with keys
            shard-X: :obj:`dict` Shard of committees, with the following keys
                committee-members: :obj:`list` List of committee members
                    ...
                    is-woop-slot: :obj:`bool` if slot is Woop owned
                ...
                wiki-voting-power: :obj:`str` Voting power of woop in percent
            ...
            is-woop-slot - Boolean : If slot is Woop owned
    ...
    API Reference
    -------------
    https://api.woopchain.com/#8eef2fc4-92db-4610-a9cd-f7b75cfbd080
    """
    method = "wikiv2_getSuperCommittees"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_total_staking(
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/staking.go#L102
    """
    method = "wikiv2_getTotalStaking"
    try:
        return int(
            rpc_request( method,
                         endpoint = endpoint,
...
def get_raw_median_stake_snapshot(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#bef93b3f-6763-4121-9c17-f0b0d9e5cc40
    """
    method = "wikiv2_getMedianRawStakeSnapshot"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
