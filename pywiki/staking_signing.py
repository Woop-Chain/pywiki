"""
Sign Woop staking transactions
"""
...
def _sign_transaction_generic(
    ...
    # serialize it
    # https://github.com/woop-chain/sdk/blob/99a827782fabcd5f91f025af0d8de228956d42b4/packages/woop-staking/src/stakingTransaction.ts#L207
...
def sign_staking_transaction( transaction_dict, private_key ):
    ...
    API Reference
    -------------
    https://github.com/woop-chain/sdk/blob/99a827782fabcd5f91f025af0d8de228956d42b4/packages/woop-staking/src/stakingTransaction.ts
    """
    assert isinstance(
