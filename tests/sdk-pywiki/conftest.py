...
# private keys
# 1f84c95ac16e6a50f08d44c7bde7aff8742212fda6e4321fde48bf83bef266dc / woc155jp2y76nazx8uw5sa94fr0m4s5aj8e5xm6fu3 (genesis)
# 3c86ac59f6b038f584be1c08fced78d7c71bb55d5655f81714f3cddc82144c65 / woc1ru3p8ff0wsyl7ncsx3vwd5szuze64qz60upg37 (transferred 503)
...
txs = [
    # same shard 503 WOC transfer from woc155jp2y76nazx8uw5sa94fr0m4s5aj8e5xm6fu3 to woc1ru3p8ff0wsyl7ncsx3vwd5szuze64qz60upg37 (0 nonce)
    ...
    # contract creation by woc1ru3p8ff0wsyl7ncsx3vwd5szuze64qz60upg37 (0 nonce)
    ...
    # cross shard transfer by woc1ru3p8ff0wsyl7ncsx3vwd5szuze64qz60upg37 (1 nonce)
...
stxs = [
    # creation of woc155jp2y76nazx8uw5sa94fr0m4s5aj8e5xm6fu3 as validator (1 nonce)
    ...
    # delegation by woc1ru3p8ff0wsyl7ncsx3vwd5szuze64qz60upg37 to woc155jp2y76nazx8uw5sa94fr0m4s5aj8e5xm6fu3 (2 nonce)
