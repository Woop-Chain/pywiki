"""
Interact with the Woop blockchain to fetch
...
def get_bad_blocks(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#0ba3c7b6-6aa9-46b8-9c84-f8782e935951
    """
    method = "wikiv2_getCurrentBadBlocks"
    try:
...
def chain_id( endpoint = DEFAULT_ENDPOINT, timeout = DEFAULT_TIMEOUT ) -> dict:
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/343dbe89b3c105f8104ab877769070ba6fdd0133/rpc/blockchain.go#L44
    """
    method = "wikiv2_chainId"
    try:
...
def get_node_metadata(
    ...
    dict with the following keys:
        ...
        version: :obj:`str` representing the Woop binary version
    ...
    API Reference
    -------------
    https://api.woopchain.com/#03c39b56-8dfc-48ce-bdad-f85776dd8aec
    https://github.com/woop-chain/woop/blob/v1.10.2/internal/params/config.go#L233
    https://github.com/woop-chain/woop/blob/9f320436ff30d9babd957bc5f2e15a1818c86584/node/api.go#L110
    """
    ...
    if has peers, dict with the following keys:
        ...
        connected-peers: :obj:`list` list of connected peers by topic
            ...
            topic: :obj:`list` topic of the connection, for example:
                'woop/0.0.1/client/beacon'
                'woop/0.0.1/node/beacon'
...
def protocol_version(
    ...
    """Get the current Woop protocol version this node supports.
    ...
    -------
    int
        The current Woop protocol version this node supports
    ...
    API Reference
    -------------
    https://api.woopchain.com/#cab9fcc2-e3cd-4bc9-b62a-13e4e046e2fd
    """
    method = "wikiv2_protocolVersion"
    try:
...
def get_num_peers(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#09287e0b-5b61-4d18-a0f1-3afcfc3369c1
    """
...
def in_sync( endpoint = DEFAULT_ENDPOINT, timeout = DEFAULT_TIMEOUT ) -> bool:
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/blockchain.go#L690
    """
    method = "wikiv2_inSync"
    try:
        return bool(
            rpc_request( method,
                         endpoint = endpoint,
...
def beacon_in_sync(
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/blockchain.go#L695
    """
    method = "wikiv2_beaconInSync"
    try:
        return bool(
            rpc_request( method,
                         endpoint = endpoint,
...
def get_sharding_structure(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#9669d49e-43c1-47d9-a3fd-e7786e5879df
    """
    method = "wikiv2_getShardingStructure"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_leader_address(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#8b08d18c-017b-4b44-a3c3-356f9c12dacd
    """
    method = "wikiv2_getLeader"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def is_last_block(
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/blockchain.go#L286
    """
    params = [ block_num, ]
    method = "wikiv2_isLastBlock"
    try:
        return bool(
            rpc_request(
                method,
...
def epoch_last_block(
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/blockchain.go#L294
    """
    params = [ epoch, ]
    method = "wikiv2_epochLastBlock"
    try:
        return int(
            rpc_request(
                method,
...
def get_circulating_supply(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#8398e818-ac2d-4ad8-a3b4-a00927395044
    """
    method = "wikiv2_getCirculatingSupply"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_total_supply(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#3dcea518-9e9a-4a20-84f4-c7a0817b2196
    """
    method = "wikiv2_getTotalSupply"
    try:
        rpc_request( method,
                     endpoint = endpoint,
                     timeout = timeout )[ "result" ]
...
def get_block_number(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#2602b6c4-a579-4b7c-bce8-85331e0db1a7
    """
    method = "wikiv2_blockNumber"
    try:
        return int(
            rpc_request( method,
                         endpoint = endpoint,
...
def get_current_epoch(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#9b8e98b0-46d1-4fa0-aaa6-317ff1ddba59
    """
    method = "wikiv2_getEpoch"
    try:
        return int(
            rpc_request( method,
                         endpoint = endpoint,
...
def get_last_cross_links(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#4994cdf9-38c4-4b1d-90a8-290ddaa3040e
    """
    method = "wikiv2_getLastCrossLinks"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_gas_price(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#1d53fd59-a89f-436c-a171-aec9d9623f48
    """
    method = "wikiv2_gasPrice"
    try:
        return int(
            rpc_request( method,
                         endpoint = endpoint,
...
def get_latest_header(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#73fc9b97-b048-4b85-8a93-4d2bf1da54a6
    """
    method = "wikiv2_latestHeader"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_header_by_number(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#01148e4f-72bb-426d-a123-718a161eaec0
    """
    method = "wikiv2_getHeaderByNumber"
    params = [ block_num ]
    try:
        return rpc_request(
            method,
...
def get_latest_chain_headers(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#7625493d-16bf-4611-8009-9635d063b4c0
    """
    method = "wikiv2_getLatestChainHeaders"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_block_by_number( # pylint: disable=too-many-arguments
    ...
    API Reference
    -------------
    https://api.woopchain.com/#52f8a4ce-d357-46f1-83fd-d100989a8243
    """
    params = [
        block_num,
        {
    ...
    method = "wikiv2_getBlockByNumber"
    try:
        return rpc_request(
            method,
            params = params,
...
def get_block_by_hash( # pylint: disable=too-many-arguments
    ...
    API Reference
    -------------
    https://api.woopchain.com/#6a49ec47-1f74-4732-9f04-e5d76160bd5c
    """
    params = [
        block_hash,
        {
...
def get_block_transaction_count_by_number(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#26c5adfb-d757-4595-9eb7-c6efef63df32
    """
    params = [ block_num ]
    method = "wikiv2_getBlockTransactionCountByNumber"
    try:
        return int(
            rpc_request(
                method,
...
def get_block_transaction_count_by_hash(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#66c68844-0208-49bb-a83b-08722bc113eb
    """
    params = [ block_hash ]
    method = "wikiv2_getBlockTransactionCountByHash"
    try:
        return int(
            rpc_request(
                method,
...
def get_block_staking_transaction_count_by_number(
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/transaction.go#L494
    """
    params = [ block_num ]
    method = "wikiv2_getBlockStakingTransactionCountByNumber"
    try:
        return int(
            rpc_request(
                method,
...
def get_block_staking_transaction_count_by_hash(
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/transaction.go#L523
    """
    params = [ block_hash ]
    method = "wikiv2_getBlockStakingTransactionCountByHash"
    try:
        return int(
            rpc_request(
                method,
...
def get_blocks( # pylint: disable=too-many-arguments
    ...
    API Reference
    -------------
    https://api.woopchain.com/#ab9bdc59-e482-436c-ab2f-10df215cd0bd
    """
    params = [
        start_block,
        end_block,
...
def get_block_signers(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#1e4b5f41-9db6-4dea-92fb-4408db78e622
    """
    params = [ block_num ]
    method = "wikiv2_getBlockSigners"
    try:
        return rpc_request(
            method,
            params = params,
...
def get_block_signers_keys(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#9f9c8298-1a4e-4901-beac-f34b59ed02f1
    """
    params = [ block_num ]
    method = "wikiv2_getBlockSignerKeys"
    try:
        return rpc_request(
            method,
            params = params,
...
def is_block_signer(
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/blockchain.go#L368
    """
    params = [ block_num, address ]
    method = "wikiv2_isBlockSigner"
    try:
        return rpc_request(
            method,
            params = params,
...
def get_signed_blocks(
    ...
    API Reference
    -------------
    https://github.com/woop-chain/woop/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/blockchain.go#L406
    """
    params = [ address ]
    method = "wikiv2_getSignedBlocks"
    try:
        return int(
            rpc_request(
                method,
...
def get_validators(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#4dfe91ad-71fa-4c7d-83f3-d1c86a804da5
    """
    params = [ epoch ]
    method = "wikiv2_getValidators"
    try:
        return rpc_request(
            method,
            params = params,
...
def get_validator_keys(
    ...
    API Reference
    -------------
    https://api.woopchain.com/#1439b580-fa3c-4d44-a79d-303390997a8c
    """
    params = [ epoch ]
    method = "wikiv2_getValidatorKeys"
    try:
        return rpc_request(
            method,
            params = params,
